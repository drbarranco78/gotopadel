 ...
 * Proporciona métodos personalizados para acceder y manipular los datos de inscripciones en los partidos.
 */
public interface InscribeRepository extends JpaRepository<Inscribe, Integer> {
     ...
     * @return true si el usuario está inscrito en el partido, false en caso contrario.
     */
    boolean existsByUsuario_idAndPartido_idPartido(Integer usuarioId, Integer partidoId);

    /**
     * Busca la inscripción de un usuario a un partido específico utilizando los ID de ambos.
     * 
     ...
     * @return Un {@link Optional} que contiene la inscripción si existe, o vacío si no se encuentra.
     */
