...
INSERT INTO USUARIO (nombre, email, fecha_nac, genero, nivel, fecha_inscripcion,rol)
VALUES ('admin', 'admin@email.com', NULL, 'Hombre', NULL, NULL, 'ADMIN');

INSERT INTO CREDENCIALES (id_usuario, password) 
VALUES (1, 'Gotopadel1');

INSERT INTO USUARIO (nombre, email, fecha_nac, genero, nivel, fecha_inscripcion) VALUES 
...
INSERT INTO UBICACION (nombre, ciudad) VALUES 
...
INSERT INTO PARTIDO (id_usuario, tipo_partido, vacantes, nivel, fecha_partido, fecha_publicacion, hora_partido, ubicacion, comentarios) VALUES 
...
INSERT INTO INSCRIBE (id_usuario, id_partido, fecha_ins) VALUES 
(2, 1, '10/12/2024'),
(3, 2, '15/11/2024'),
(4, 3, '15/01/2025'),
(5, 4, '10/12/2024'),
